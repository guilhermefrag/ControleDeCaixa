...
public class MovimentacaoDAO {
    ...
    private String selectComClausula = "SELECT * from movimentacao WHERE id_usuario = ?";
    private String insert = "INSERT into movimentacao " + "(idUsuario, tipo, valor) VALUES (?, ?, ?)";
    ...
    public List<Movimentacao> SelectComClausula(Object param) throws SQLException {
        Movimentacao p = (Movimentacao) param;
        ...
        while (resultado.next()) {
            ...
            p2.setValor(resultado.getFloat("valor"));
