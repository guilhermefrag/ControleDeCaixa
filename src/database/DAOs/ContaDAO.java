...
public class ContaDAO {
    ...
    private String getSaldo = "SELECT valor_total from conta WHERE id_usuario = ?";

    private PreparedStatement pstSelectComClasula;
    private PreparedStatement pstInsert;
    private PreparedStatement pstUpdate;
    private PreparedStatement pstGetSaldo;
    ...
    public ContaDAO(Connection conexao) throws SQLException {
        ...
        pstGetSaldo = this.conexao.prepareStatement(getSaldo);
    }
    ...
    public double getSaldo(int idUsuario) throws SQLException {
        pstGetSaldo.setInt(1, idUsuario);

        ResultSet resultado = pstGetSaldo.executeQuery();
        double saldo = 0;

        while (resultado.next()) {
            saldo = resultado.getDouble("valor_total");
        }
        return saldo;
    }
